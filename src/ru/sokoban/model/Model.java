...
public class Model {
    ...
    // Именно этот размер будет участвовать в расчёте движения и столкновений объектов.
    ...
    private LevelLoader levelLoader = new LevelLoader(Paths.get(".\\levels.txt"));
    ...
    public void checkCompletion() {
        ...
        for (Home home : gameObjects.getHomes()) {
            boolean isAnyOneBoxAtHome = false;
            for (Box box: gameObjects.getBoxes()) {
                if (box.getX() == home.getX() && box.getY() == home.getY())
                    isAnyOneBoxAtHome = true;
            }
            if (!isAnyOneBoxAtHome)
